...
ggplot(x,aes(x=Prob)) + geom_histogram(colour="grey",fill="grey10",binwidth=0.05) +labs(x="Estimated probability of positivity")
ggsave("ens-probabilities-hist.png",height=4*w,width=4*w)
