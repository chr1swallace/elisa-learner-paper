...
ggplot(pred[type=="Combined" & Week!="Combined"],aes(x=week_num,y=qm,ymin=ll,ymax=ul#,col=type
                                  )) +
...
```{r}
library(seaborn)
ggplot(pred[type!="Combined" & Week!="Combined"],aes(x=week_num+as.numeric(factor(type))/10,
